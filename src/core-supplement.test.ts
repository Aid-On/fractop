/**
 * FractoP Core Tests - Error Recovery, Callbacks, Supplement, Merge Utilities
 */

import { describe, it, expect, vi, beforeEach } from 'vitest';
import { FractalProcessor, simpleMerge, weightedMerge } from './core';
import type {
  LLMProvider,
  ProcessOptions,
  FractalEvent,
...
describe('FractalProcessor - Error Recovery', () => {
  let llm: LLMProvider;
...
describe('FractalProcessor - Callbacks', () => {
  let llm: LLMProvider;
...
describe('FractalProcessor - Supplement', () => {
  let llm: LLMProvider;
