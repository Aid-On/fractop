 ...
 * ```
 */
export function createLLMAdapter(processChunk) {
    return {
 ...
 * ```
 */
export function createUnillMAdapter(model, credentials) {
    return {
        async chat(systemPrompt, userPrompt, options) {
            ...
            // return result.text;
            throw new Error('UnillM adapter requires manual implementation. ' +
